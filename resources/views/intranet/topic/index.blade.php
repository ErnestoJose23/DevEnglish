                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @else
                            ...
                            <a href="{{ route('teacherterminos.index', $topic) }}" class="btn btn-light btn-circle" data-toggle="tooltip" data-placement="bottom" title="Terminos"><i class="fas fa-sort-alpha-down"></i></a>
