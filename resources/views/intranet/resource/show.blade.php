                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="tipe" id="inputState" class="form-control" disabled>
                                    <option @if($resource->tipe) == 1) selected @endif  value="1">Video</option>
                                    <option @if($resource->tipe) == 2) selected @endif value="2">Link</option>
                                </select>
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6"> 
                                <img src="/uploads/media/{{ $resource->img() }}" width="250px"/>
                            </div>
                        </div>                     
