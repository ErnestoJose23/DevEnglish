                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="isActive" id="inputState" class="form-control">
                                    <option @if(old('isActive', $resource->isActive) == 0) selected @endif value="0">No</option>
                                    <option @if(old('isActive', $resource->isActive) == 1) selected @endif value="1">Si</option>
                                </select>
